...
const oms = {
  ...
  p2_1: `p2_${startingArmies['2'][1]}`,
  p2_2: `p2_${startingArmies['2'][1]}`,
  p2_X: `p2_${startingArmies['2'][0]}`,
  p3_0: `p3_${startingArmies['3'][0]}`,
  p3_1: `p3_${startingArmies['3'][1]}`,
  p3_2: `p3_${startingArmies['3'][1]}`,
  p3_X: `p3_${startingArmies['3'][0]}`,
  p4_0: `p4_${startingArmies['4'][0]}`,
  p4_1: `p4_${startingArmies['4'][1]}`,
  p4_2: `p4_${startingArmies['4'][1]}`,
  p4_X: `p4_${startingArmies['4'][0]}`,
  p5_0: `p5_${startingArmies['5'][0]}`,
  p5_1: `p5_${startingArmies['5'][1]}`,
  p5_2: `p5_${startingArmies['5'][1]}`,
